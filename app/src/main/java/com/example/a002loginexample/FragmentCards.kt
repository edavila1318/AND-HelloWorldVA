 ...
 * Use the [FragmentCards.newInstance] factory method to
...
class FragmentCards : Fragment() {
    ...
    override fun onCreateView(
        ...
        //recyclerView
        var recyclerView = binding.cardsRecyclerView
        recyclerView.layoutManager = LinearLayoutManager(this.context)


        //get cards
        val res = cardApi().getCards(userID,recyclerView)
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentCards.
         */
